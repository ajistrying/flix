...
movie.reviews.create!(name: "Larry", stars: 5, comment: "Amazing!")
movie.reviews.create!(name: "Curly", stars: 4, comment: "Wonderful!")
movie.reviews.create!(name: "Moe", stars: 3, comment: "Outstanding!")

movie = Movie.find_by(title: "Captain Marvel")
movie.reviews.create!(name: "Larry", stars: 4, comment: "Amazing!")
movie.reviews.create!(name: "Curly", stars: 4, comment: "Wonderful!")
movie.reviews.create!(name: "Moe", stars: 3, comment: "Outstanding!")